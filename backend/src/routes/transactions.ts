...
router.get('/third-parties', asyncHandler(async (req, res) => {
...
router.post('/', asyncHandler(async (req, res) => {
  const { yearId, itemId, date, description, comment, thirdParty, paymentMethod, amount, accountingMonth, accountingYear } = req.body;
...
router.put('/:id', asyncHandler(async (req, res) => {
  ...
  const { itemId, date, description, comment, thirdParty, paymentMethod, amount, accountingMonth, accountingYear, recalculateAccounting } = req.body;
