...
const translations: Record<Locale, Record<string, any>> = {
  en: {
    ...
    sharing: {
      ...
      writeAccess: 'Can edit',
      readOnlyBanner: 'You have read-only access to this budget. Changes are disabled by the server.',
      tab: 'Sharing',
      title: 'Share this budget',
      help: 'The other person must already have a Tallix account. You can share with multiple people.',
      emailPlaceholder: 'person@example.com',
      readOnly: 'Read only',
      canEdit: 'Can edit',
      share: 'Share',
      peopleWithAccess: 'People with access',
      noShares: 'This budget is not shared with anyone yet.',
      sharedSuccessfully: 'Budget access granted.',
      removeTitle: 'Remove budget access',
      removeConfirm: 'Remove access for {email}?',
    },
    copilot: {
      title: 'Ask Tallix',
    ...
    playground: {
      title: 'Budget Playground - {year}',
      subtitle: 'Experiment with budget scenarios without saving changes',
      resetToInitial: 'Reset to initial',
      setAllToZero: 'Set all to zero',
      resetConfirm: 'Reset all values to the original budget?',
      zeroConfirm: 'Set all budget values to zero?',
      unsavedNote: 'Changes on this page are not saved.',
      importActuals: 'Import actuals',
      importActualsConfirm: 'Replace budget values with actual spending for the first {count} month(s)?',
      clearRow: 'Clear row',
    },
    spreadsheet: {
      category: 'Category',
    ...
    assets: {
      ...
      addDebt: 'Add Debt',
      addDebtSection: 'Add Section',
      sectionName: 'Section name',
      sectionNamePlaceholder: 'e.g., Real Estate, Vehicles',
      debtSectionNamePlaceholder: 'e.g., Mortgage, Loans',
    ...
    settings: {
      ...
      startYearHelp:
        'The earliest year shown in the app. Setting an earlier year will create missing years automatically.',
      ...
      exportHelp: 'Download a full backup of your budget data as a JSON file.',
      exportSuccess: 'Backup exported successfully',
      importLabel: 'Restore backup',
      importButton: 'Upload JSON',
      importHelp: 'Restore data from a previously exported backup. All existing data will be replaced.',
      importConfirmTitle: 'Restore backup',
      importConfirmMessage:
        'All your existing data (categories, transactions, accounts, assets…) will be permanently deleted and replaced by the backup contents. This action cannot be undone. Continue?',
      importConfirmLabel: 'Delete and restore',
      importSuccess: '{count} records imported successfully',
      importInvalidJson: 'The selected file is not a valid JSON backup',
    },
    transactions: {
      ...
      moveSelectionToTop: 'Move selection to top',
      moveSelectionToBottom: 'Move selection to bottom',
    },
    bulkImport: {
      ...
      errors: {
        ...
        noValidTransactions: 'No valid transactions found. Check that your data matches the configured column order.',
    ...
    errors: {
      BUDGET_SHARE_USER_NOT_FOUND: 'No Tallix account exists for this email address.',
      BUDGET_SHARE_ALREADY_OWNER: 'You already own this budget.',
  ...
  fr: {
    ...
    sharing: {
      ...
      writeAccess: 'Modification',
      readOnlyBanner: "Vous avez un accès en lecture seule à ce budget. Les modifications sont bloquées par le serveur.",
      tab: 'Partage',
      title: 'Partager ce budget',
      help: "L’autre personne doit déjà avoir un compte Tallix. Vous pouvez partager avec plusieurs personnes.",
      emailPlaceholder: 'personne@exemple.com',
      readOnly: 'Lecture seule',
      canEdit: 'Peut modifier',
      share: 'Partager',
      peopleWithAccess: 'Personnes ayant accès',
      noShares: "Ce budget n’est encore partagé avec personne.",
      sharedSuccessfully: 'Accès au budget accordé.',
      removeTitle: "Retirer l’accès au budget",
      removeConfirm: "Retirer l’accès de {email} ?",
    },
    copilot: {
    ...
    playground: {
      title: 'Simulation du Budget - {year}',
      subtitle: 'Expérimentez des scénarios budgétaires sans sauvegarder les modifications',
      resetToInitial: 'Réinitialiser',
      setAllToZero: 'Tout mettre à zéro',
      resetConfirm: 'Réinitialiser toutes les valeurs au budget initial ?',
      zeroConfirm: 'Mettre toutes les valeurs budgétaires à zéro ?',
      unsavedNote: 'Les modifications sur cette page ne sont pas sauvegardées.',
      importActuals: 'Importer les réels',
      importActualsConfirm:
        'Remplacer les valeurs budgétaires par les dépenses réelles pour les {count} premier(s) mois ?',
    ...
    assets: {
      ...
      addDebtSection: 'Ajouter une section',
      sectionName: 'Nom de la section',
      sectionNamePlaceholder: 'ex: Immobilier, Véhicules',
      debtSectionNamePlaceholder: 'ex: Hypothèque, Prêts',
      ...
      noAssetsSubtitle:
        "Ajoutez des actifs personnalisés comme l'immobilier ou les véhicules pour suivre votre patrimoine",
    ...
    settings: {
      ...
      startYearHelp:
        "La première année affichée dans l'application. Définir une année antérieure créera automatiquement les années manquantes.",
      ...
      exportHelp: 'Téléchargez une sauvegarde complète de votre budget au format JSON.',
      exportSuccess: 'Sauvegarde exportée avec succès',
      importLabel: 'Restaurer',
      importButton: 'Importer JSON',
      importHelp: "Restaurez vos données à partir d'une sauvegarde. Toutes les données existantes seront remplacées.",
      importConfirmTitle: 'Restaurer la sauvegarde',
      importConfirmMessage:
        'Toutes vos données existantes (catégories, transactions, comptes, actifs…) seront définitivement supprimées et remplacées par le contenu de la sauvegarde. Cette action est irréversible. Continuer ?',
      importConfirmLabel: 'Supprimer et restaurer',
      importSuccess: '{count} enregistrements importés avec succès',
      importInvalidJson: "Le fichier sélectionné n'est pas une sauvegarde JSON valide",
    },
    transactions: {
      ...
      moveSelectionUp: 'Monter la sélection',
      moveSelectionDown: 'Descendre la sélection',
      moveSelectionToTop: 'Placer la sélection en haut',
      moveSelectionToBottom: 'Placer la sélection en bas',
    },
    bulkImport: {
      ...
      errors: {
        ...
        noPdfTransactionsUnsupported:
          "Aucune transaction trouvée dans le PDF. Le format n'est peut-être pas pris en charge.",
        ...
        rowsNoCategory:
          "Les lignes {rows} n'ont pas de catégorie. Veuillez assigner une catégorie à chaque transaction.",
    ...
    errors: {
      BUDGET_SHARE_USER_NOT_FOUND: "Aucun compte Tallix n’existe pour cette adresse e-mail.",
      BUDGET_SHARE_ALREADY_OWNER: 'Vous êtes déjà propriétaire de ce budget.',
