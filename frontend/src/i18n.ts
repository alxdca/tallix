...
const translations: Record<Locale, Record<string, any>> = {
  en: {
    ...
    settings: {
      ...
      importConfirmMessage: 'All your existing data (categories, transactions, accounts, assets…) will be permanently deleted and replaced by the backup contents. This action cannot be undone. Continue?',
  ...
  fr: {
    ...
    settings: {
      ...
      importConfirmMessage: 'Toutes vos données existantes (catégories, transactions, comptes, actifs…) seront définitivement supprimées et remplacées par le contenu de la sauvegarde. Cette action est irréversible. Continuer ?',
